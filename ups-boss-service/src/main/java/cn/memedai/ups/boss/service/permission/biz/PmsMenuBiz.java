...
public class PmsMenuBiz {
	...
	@Autowired
	private PmsMenuDOMapper pmsMenuDOMapper;
	...
	@Autowired
	private PmsRoleMenuDOMapper pmsRoleMenuDOMapper;
	
	
	@Autowired
	private PmsRoleActionService pmsRoleActionService;
	@Autowired
	private PmsRoleActionDOMapper pmsRoleActionDOMapper;
	...
	private List<PmsMenuDO> getTreeData(String parentId) {
		return pmsMenuService.listByParent(parentId);
	}
	...
	public void delete(Long id) {
		this.pmsMenuDOMapper.deleteByPrimaryKey(id);
	}

	@SuppressWarnings("rawtypes")
	public List listByRoleIds(String roleIdsStr) {
		return this.pmsMenuService.listByRoleIds(roleIdsStr);
	}
	...
	public String buildPermissionTree(String roleIds) throws PermissionException {
		...
		try {
			treeData = this.pmsMenuService.listByRoleIds(roleIds);
	...
	public List<PmsMenuDO> listByParentId(Long parentId) {
		return pmsMenuService.listByParentId(parentId);
	}
	...
	public List<PmsMenuDO> getMenuByNameAndIsLeaf(Short isLeaf,String name) {
		return pmsMenuService.getMenuByNameAndIsLeaf(isLeaf, name);
	}
	 ...
	 * @return
	 */
	public PmsMenuDO getById(Long pid) {
		PmsMenuDO pmsMenuDO = pmsMenuDOMapper.selectByPrimaryKey(pid);
	 ...
	 * @param menu
	 */
	public void update(PmsMenuDO menu) {
		pmsMenuDOMapper.updateByPrimaryKeySelective(menu);
