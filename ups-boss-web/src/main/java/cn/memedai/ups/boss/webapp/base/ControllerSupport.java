...
import cn.memedai.ups.boss.service.model.DwzParam;
import cn.memedai.ups.boss.service.page.PageParam;
import cn.memedai.ups.boss.utils.StrUtil;
import cn.memedai.ups.boss.utils.UdpGetClientMacAddr;

/**
 * 自定义Controller支撑类. <br/>
 * 添加结合DWZ-UI框架的Action层可共用方法 .
 * 添加结合DWZ-UI框架的分页参数获取方法 .
 * @author: chengtx
 * @创建时间: 2016-11-29,下午9:36:02
 *
 */
@Slf4j
public class ControllerSupport {
	...
	public HttpServletRequest getHttpRequest() {
		return ThreadLocalContext.getHttpRequest();
	}
	...
	public String getSessionId() {
		return ThreadLocalContext.getHttpRequest().getSession().getId();
	}
	...
	public HttpServletResponse getHttpResponse() {
		return ThreadLocalContext.getHttpResponse();
	}
	...
	public void write(String msg) {
		...
		try {
			ThreadLocalContext.getHttpResponse().setHeader("Content-type", "text/html;charset=UTF-8");
			write = ThreadLocalContext.getHttpResponse().getWriter();
		} catch (IOException e) {
			log.error("",e);
		}
		write.write(msg);
	...
	// ////////////////////////////////////////////////////////////////////////
	// /////////////// 添加结合DWZ-UI框架的Controller层可共用方法 //////////////////////
	// /////////////// tongxiong.cheng 2016-11-30 /////////////////////////////////
	/**
	...
	public void oprateparameter(String str1, String str2) {
		HttpServletRequest req = ThreadLocalContext.getHttpRequest();
	...
	public Map<String, Object> getParamMap() {
		...
		Map<String, Object> map = getHttpRequest().getParameterMap();
