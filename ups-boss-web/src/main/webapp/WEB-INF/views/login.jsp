...
<link href="${rc.contextPath}/statics/dwz/themes/css/login.css" rel="stylesheet" type="text/css" />
<script src="${rc.contextPath}/statics/dwz/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<style type="text/css">
...
<body>
	<div id="login">
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="${rc.contextPath}/login/operatorLogin" method="post">
					<p>
						<label>用户名：</label>
					...
					<div style="width:260px;height:50px;">
						...
						<img id="kaptchaImage" src="${rc.contextPath}/randomCode.jpg" style="width:75px;height:26px;float:left;" />
			...
			<div class="login_banner"><img src="${rc.contextPath}/statics/dwz/themes/default/images/login_banner.jpg" style="width:630px;height:470px;" /></div>
...
$('#kaptchaImage').click(function(){$(this).hide().attr('src','${rc.contextPath}/randomCode.jpg?'+Math.floor(Math.random()*100)).fadeIn(100);});
</script>
</body>
</html>