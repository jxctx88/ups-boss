...
<div class="pageContent">
	<form id="form" method="post" action="${rc.contextPath}/pms/operatorChangeOwnPwd" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
