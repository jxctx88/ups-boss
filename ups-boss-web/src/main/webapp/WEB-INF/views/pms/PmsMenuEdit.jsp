...
<div class="pageContent">
	<form id="editPmsMenu1" method="post" action="${rc.contextPath}/pmsMenu/editPmsMenu" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
