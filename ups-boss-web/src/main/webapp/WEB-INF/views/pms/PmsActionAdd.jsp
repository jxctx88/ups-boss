...
<div class="pageContent">
	<form id="form1" method="post" action="${rc.contextPath}/pms/addPmsAction" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			...
			<p>
				...
				<a class="btnLook" href="${rc.contextPath}/pms/pmsMenuLookUpUI" lookupgroup="menu" width="350">菜单模块</a>
			</p>
			<p style="width:99%">
				<label></label>
