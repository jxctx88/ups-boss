...
<div class="pageContent">
	<form id="form" method="post" action="${rc.contextPath}/pms/addPmsOperator" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="60">
			...
			<p style="width:99%">
				...
				<input name="realName" class="required" maxlength="45" size="30">
			</p>
			<p style="width:99%">
				<label>操作员登录名：</label>
			...
			<p style="width:99%">
				...
				<input type="text" name="mobileNo"  class="required" maxlength="20" size="30" />
			</p>
			<p style="width:99%">
				<label>状态：</label>
			...
			<p style="width:99%;height:50px;">
				...
				<textarea rows="3" cols="30" name="desc" class="required" maxlength="100"></textarea>
			</p>
			
			<fieldset style="width:99%">
				<legend>选择角色<font color="red">*</font></legend>
				<c:forEach items="${rolesList}" var="pmsRoleDO">
					<c:if test="${pmsRoleDO.roletype eq RoleTypeEnum.USER.value}">
						<label>
							<input class="selectOperatorRole" type="checkbox" name="selectRole" value="${pmsRoleDO.id}">${pmsRoleDO.rolename }
						</label>
					</c:if>
				</c:forEach>
			</fieldset>
