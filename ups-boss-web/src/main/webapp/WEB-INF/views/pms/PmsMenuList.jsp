...
<form id="treeForm1" onsubmit="return navTabSearch(this);" action="${rc.contextPath}/pmsMenu/listPmsMenu" method="post" >
</form>
			...
			<div>
				<div class="panelBar" style="width:262px">
					...
					<z:permission value="pms:menu:add">
						<li>
							<a id="addMenu" class="add" href="${rc.contextPath}/pmsMenu/addPmsMenuUI" target="dialog" rel="input" width="600" height="400" title="添加菜单"><span>添加</span></a>
						</li>
					</z:permission>
					<z:permission value="pms:menu:delete">
						<li>
							<a id="delMenu" class="delete" href="${rc.contextPath}/pmsMenu/delPmsMenu" callback="navTabAjax" target="ajaxTodo" rel="inputMenu"  title="确定执行该删除操作吗？"><span>删除</span></a>
						</li>
					</z:permission>
...
<script type="text/javascript">
	function  onClickMenuNode(id){
		$("#addMenu").attr("href","${rc.contextPath}/pmsMenu/addPmsMenuUI?pid="+id);
		$("#delMenu").attr("href","${rc.contextPath}/pmsMenu/delPmsMenu?id="+id);
	}
	function onscreach(){
		$("#treeForm1").submit();
	}
