...
<div class="pageContent">
	<form id="form" method="post" action="${rc.contextPath}/pms/editPmsRole" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="60">
			...
			<input type="hidden" name="id" id="roleId" value="${pmsRole.id}">
			
			<p>
				<label>角色名称：</label>
				<!-- <s:textfield name="roleName" cssClass="required" minlength="3" maxlength="90" size="30" /> -->
				<input type="text" class="required" value="${pmsRole.rolename}" name="roleName" minlength="3" maxlength="90" size="30" >
			</p>
			<p style="height:50px;">
				<label>角色描述：</label>
