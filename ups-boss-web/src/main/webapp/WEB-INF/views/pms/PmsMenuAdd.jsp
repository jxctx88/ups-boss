...
<div class="pageContent">
	<form id="form" method="post" action="${rc.contextPath}/pmsMenu/addPmsMenu" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
