...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @throws ParseException 
	 */
	public static Date getMaxTime(Date dt) throws ParseException {
	 ...
	 * @throws ParseException 
	 */
	public static Date getMinTime(Date dt) throws ParseException {
		Date dt1 = null;
	 ...
	 * @throws ParseException 
	 */
	public static Date getPreviousMonthFirstDay() throws ParseException {
	 ...
	 * @throws ParseException 
	 */
	public static Date getPreviousMonthLastDay() throws ParseException {
		Calendar lastDate = Calendar.getInstance();
		lastDate.set(Calendar.DATE, 1);// 设为当前月的1号
